...
const Link = /* @__PURE__ */ reactExports.forwardRef(function LinkWithRef(_ref4, ref) {
  ...
  return /* @__PURE__ */ reactExports.createElement("a", _extends({}, rest, {
    href,
...
const SERVER_URL = "https://annytodo.run.goorm.app/";
const getToken = () => {
...
function AuthContextProvider({
  ...
  const [userToken, setUserToken] = reactExports.useState(tokenStorage.getToken());
  const [isAuthenticated, setIsAuthenticated] = reactExports.useState(userToken ? true : false);
...
const Nav = /* @__PURE__ */ createStyled("nav", {
  ...
  name: "fhziqd",
  styles: "display:flex;position:fixed;justify-content:space-around;align-items:center;background-color:lightgray;top:0%;width:100vw;padding:0.6em"
});
const Button = /* @__PURE__ */ createStyled("button", {
  target: "ei2nq1p0"
})({
  name: "1rcp52d",
  styles: "font-weight:bold;background-color:white;border-radius:1rem;border:2px solid gray;margin:0 0.5rem;padding:0.375rem"
});
function GlobalNavBar() {
  ...
  return /* @__PURE__ */ jsxs(Nav, { children: [
    /* @__PURE__ */ jsx(NavLink, { to: "/", children: /* @__PURE__ */ jsx("p", { children: "Home" }) }),
    isAuthenticated ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(NavLink, { to: "/todo", children: /* @__PURE__ */ jsx("p", { children: "Todo" }) }),
      /* @__PURE__ */ jsx(Button, { type: "button", onClick: onClickLogout, children: "로그아웃" })
    ] }) : /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(NavLink, { to: "/login", children: /* @__PURE__ */ jsx(Button, { type: "button", children: "로그인" }) }),
      /* @__PURE__ */ jsx(NavLink, { to: "/signup", children: /* @__PURE__ */ jsx(Button, { type: "button", children: "회원가입" }) })
    ] })
  ] });
}
function Loading() {
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h2", { children: "Loading..." }) });
}
const PrivateRoute = ({
  children
}) => {
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsx(Navigate, { to: "/", state: {
      from: location
    }, replace: true });
  }
  return /* @__PURE__ */ jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsx(Loading, {}), children });
};
const PublicRoute = ({
  children
}) => {
...
function MainPage() {
  return /* @__PURE__ */ jsx("main", { children: "Main Page" });
}
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./index-57117869.js"), true ? ["assets/index-57117869.js","assets/styled-126e34d8.js","assets/api-18387136.js"] : void 0));
const SignUpPage = reactExports.lazy(() => __vitePreload(() => import("./index-992e8749.js"), true ? ["assets/index-992e8749.js","assets/styled-126e34d8.js","assets/api-18387136.js"] : void 0));
const TodoPage = reactExports.lazy(() => __vitePreload(() => import("./index-c8e63d55.js"), true ? ["assets/index-c8e63d55.js","assets/api-18387136.js"] : void 0));
function App() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(GlobalNavBar, {}),
    /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsx(Route, { path: "/", element: /* @__PURE__ */ jsx(MainPage, {}) }),
      /* @__PURE__ */ jsx(Route, { path: "/login", element: /* @__PURE__ */ jsx(PublicRoute, { children: /* @__PURE__ */ jsx(LoginPage, {}) }) }),
      /* @__PURE__ */ jsx(Route, { path: "/signup", element: /* @__PURE__ */ jsx(PublicRoute, { children: /* @__PURE__ */ jsx(SignUpPage, {}) }) }),
      /* @__PURE__ */ jsx(Route, { path: "/todo", element: /* @__PURE__ */ jsx(PrivateRoute, { children: /* @__PURE__ */ jsx(TodoPage, {}) }) })
    ] })
  ] });
}
const reset = {
  name: "mq5whd",
  styles: "html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline;}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block;}body{line-height:1;}ol,ul{list-style:none;}blockquote,q{quotes:none;}blockquote:before,blockquote:after,q:before,q:after{content:'';content:none;}table{border-collapse:collapse;border-spacing:0;}main{display:flex;justify-content:center;margin-top:4rem;}"
};
const queryClient = new QueryClient();
client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxs(React.StrictMode, { children: [
  /* @__PURE__ */ jsx(Global, { styles: reset }),
  /* @__PURE__ */ jsx(AuthContextProvider, { children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(BrowserRouter, { basename: "/new-Todo-List", children: /* @__PURE__ */ jsx(App, {}) }) }) })
] }));
export {
  Fragment as F,
  Link as L,
  ...
  timeUntilStale as f,
  focusManager as g,
  replaceEqualDeep as h,
  isServer as i,
  jsx as j,
  getLogger as k,
  isCancelledError as l,
  notifyManager as m,
  noop as n,
  Subscribable as o,
  getDefaultState as p,
