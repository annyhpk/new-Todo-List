import { r as reactExports, c as createStyled, b as jsxs, j as jsx, F as Fragment, S as SERVER_URL, t as tokenStorage } from "./index-1cb03450.js";
const validation = {
...
const useInput = (initialValue, validType) => {
  ...
  const isValidInput = reactExports.useMemo(() => Validation(validType, String(value)), [validType, value]);
  return [value, onChange, isValidInput];
};
const StyledInput = /* @__PURE__ */ createStyled("input", {
  target: "e1pbgypp1"
})("width:", (props) => props.width, ";height:", (props) => props.height, ";border:2px solid;border-radius:0.75rem;padding:0.2rem 0.75rem;font-size:16px;");
const ValidationAlert = /* @__PURE__ */ createStyled("p", {
  target: "e1pbgypp0"
})({
  name: "1u85yy3",
  styles: "color:#f05650;font-size:12px"
});
function Input({
  name,
  type,
  ...
  const [value, onChangeValue, isValidInput] = useInput("", validationType2);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(StyledInput, { ref, name, width, height, type, value, onChange: onChangeValue, placeholder, autoComplete: "off" }),
    isValidInput ? null : /* @__PURE__ */ jsx(ValidationAlert, { children: msg })
  ] });
}
const Input$1 = reactExports.forwardRef(Input);
